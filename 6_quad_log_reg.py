...
save = True
newfile = False
filename = 'results/quad_log_reg.txt'
progress = True
n_split = 100
...
lambda_range = [1e-6, 1e-5]#, 1e-4, 0.001, 0.01, 0.1, 1., 10.]
            ...
            for mPCA in mPCA_range:
                ...
                for mLDA in mLDA_range:
                    ...
                    for lam in lambda_range:
                        ...
                        scores_i.append(lr.binary_quadratic_log_reg(Dtr_l, Ltr, Dte_l, 0, lam, prior, retScores= True))
                        place += 1
        ...
        for mPCA in mPCA_range:
            for mLDA in mLDA_range:
                ...
                for lam in lambda_range:
                    ...
                    effective = 1/10
                    assigned = np.array([0 if scores[i]<-np.log(effective/(1-effective)) else 1 for i in range(n_cons)], dtype= int)
