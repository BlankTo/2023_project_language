...
idx_shuffle = np.random.permutation(len(scores_quad_log_reg))
scores_tr = scores_quad_log_reg[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_quad_log_reg[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_quad_log_reg[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_quad_log_reg[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
...
minDCF, best_threshold_quad_log_reg_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.2): {best_threshold_quad_log_reg_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_02, 0.2, 1, 1)

minDCF, best_threshold_quad_log_reg_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.5): {best_threshold_quad_log_reg_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_05, 0.5, 1, 1)

minDCF, best_threshold_quad_log_reg_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.8): {best_threshold_quad_log_reg_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_rbf))
scores_tr = scores_rbf[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_rbf[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_rbf[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_rbf[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
...
minDCF, best_threshold_rbf_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.2): {best_threshold_rbf_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_02, 0.2, 1, 1)

minDCF, best_threshold_rbf_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.5): {best_threshold_rbf_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_05, 0.5, 1, 1)

minDCF, best_threshold_rbf_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.8): {best_threshold_rbf_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_08, 0.8, 1, 1)
