...
idx_shuffle = np.random.permutation(len(scores_quad_log_reg_1))
scores_tr = scores_quad_log_reg_1[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_quad_log_reg_1[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_quad_log_reg_1[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_quad_log_reg_1[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'Quad LogReg nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'Quad LogReg nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'Quad LogReg nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_quad_log_reg_1_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.2): {best_threshold_quad_log_reg_1_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_1_02, 0.2, 1, 1)

minDCF, best_threshold_quad_log_reg_1_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.5): {best_threshold_quad_log_reg_1_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_1_05, 0.5, 1, 1)

minDCF, best_threshold_quad_log_reg_1_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.8): {best_threshold_quad_log_reg_1_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_1_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_quad_log_reg_2))
scores_tr = scores_quad_log_reg_2[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_quad_log_reg_2[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_quad_log_reg_2[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_quad_log_reg_2[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'Quad LogReg nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'Quad LogReg nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'Quad LogReg nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_quad_log_reg_2_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.2): {best_threshold_quad_log_reg_2_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_2_02, 0.2, 1, 1)

minDCF, best_threshold_quad_log_reg_2_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.5): {best_threshold_quad_log_reg_2_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_2_05, 0.5, 1, 1)

minDCF, best_threshold_quad_log_reg_2_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'Quad LogReg best_threshold(0.8): {best_threshold_quad_log_reg_2_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_quad_log_reg_2_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_poly2))
scores_tr = scores_poly2[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_poly2[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_poly2[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_poly2[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'Poly 2 SVM nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'Poly 2 SVM nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'Poly 2 SVM nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_poly2_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'Poly 2 SVM best_threshold(0.2): {best_threshold_poly2_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_poly2_02, 0.2, 1, 1)

minDCF, best_threshold_poly2_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'Poly 2 SVM best_threshold(0.5): {best_threshold_poly2_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_poly2_05, 0.5, 1, 1)

minDCF, best_threshold_poly2_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'Poly 2 SVM best_threshold(0.8): {best_threshold_poly2_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_poly2_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_rbf_1))
scores_tr = scores_rbf_1[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_rbf_1[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_rbf_1[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_rbf_1[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'RBF SVM nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'RBF SVM nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'RBF SVM nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_rbf_1_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.2): {best_threshold_rbf_1_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_1_02, 0.2, 1, 1)

minDCF, best_threshold_rbf_1_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.5): {best_threshold_rbf_1_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_1_05, 0.5, 1, 1)

minDCF, best_threshold_rbf_1_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.8): {best_threshold_rbf_1_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_1_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_rbf_2))
scores_tr = scores_rbf_2[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_rbf_2[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_rbf_2[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_rbf_2[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'RBF SVM nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'RBF SVM nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'RBF SVM nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_rbf_2_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.2): {best_threshold_rbf_2_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_2_02, 0.2, 1, 1)

minDCF, best_threshold_rbf_2_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.5): {best_threshold_rbf_2_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_2_05, 0.5, 1, 1)

minDCF, best_threshold_rbf_2_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'RBF SVM best_threshold(0.8): {best_threshold_rbf_2_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_rbf_2_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_gmm))
scores_tr = scores_gmm[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_gmm[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_gmm[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_gmm[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'GMM nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'GMM nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'GMM nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_gmm_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'GMM best_threshold(0.2): {best_threshold_gmm_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_gmm_02, 0.2, 1, 1)

minDCF, best_threshold_gmm_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'GMM best_threshold(0.5): {best_threshold_gmm_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_gmm_05, 0.5, 1, 1)

minDCF, best_threshold_gmm_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'GMM best_threshold(0.8): {best_threshold_gmm_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_gmm_08, 0.8, 1, 1)
...
idx_shuffle = np.random.permutation(len(scores_gmm_tied))
scores_tr = scores_gmm_tied[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
scores_te = scores_gmm_tied[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]
LTE_cross_tr = LTE_cross_gmm_tied[idx_shuffle][:int(len(idx_shuffle) * 2 / 3)]
LTE_cross_te = LTE_cross_gmm_tied[idx_shuffle][int(len(idx_shuffle) * 2 / 3):]

print(f'GMM nDCF(0.2): {utils.get_metrics(scores_te, LTE_cross_te, 0.2, 1, 1, ret_all= True)[1]}')
print(f'GMM nDCF(0.5): {utils.get_metrics(scores_te, LTE_cross_te, 0.5, 1, 1, ret_all= True)[1]}')
print(f'GMM nDCF(0.8): {utils.get_metrics(scores_te, LTE_cross_te, 0.8, 1, 1, ret_all= True)[1]}')

minDCF, best_threshold_gmm_tied_02 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.2, 1, 1, retThreshold= True)
print(f'GMM best_threshold(0.2): {best_threshold_gmm_tied_02} - minDCF(0.2): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_gmm_tied_02, 0.2, 1, 1)

minDCF, best_threshold_gmm_tied_05 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.5, 1, 1, retThreshold= True)
print(f'GMM best_threshold(0.5): {best_threshold_gmm_tied_05} - minDCF(0.5): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_gmm_tied_05, 0.5, 1, 1)

minDCF, best_threshold_gmm_tied_08 = utils.getMinNormDCF(scores_tr, LTE_cross_tr, 0.8, 1, 1, retThreshold= True)
print(f'GMM best_threshold(0.8): {best_threshold_gmm_tied_08} - minDCF(0.8): {minDCF}')
utils.get_metrics_threshold(scores_te, LTE_cross_te, best_threshold_gmm_tied_08, 0.8, 1, 1)
