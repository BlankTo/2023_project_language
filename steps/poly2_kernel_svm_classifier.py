...
for prior in [0.5, None]: #[0.2, 0.5, 0.8]:
    ...
    for C in C_range:
        ...
        LTE_cross, _, scores = utils.cross_validation_base(D_BASE, L, svm.SupportVectorMachine, 10, None, None, 0, [0, C, svm.get_kernel_poly(0, 2, 0), None] if prior is None else [0, C, svm.get_kernel_poly(0, 2, 0), [1 - prior, prior]], True)
...
for prior in [0.5, None]: #[0.2, 0.5, 0.8]:
    ...
    for C in C_range:
        ...
        LTE_cross, _, scores = utils.cross_validation_base(D_BASE, L, svm.SupportVectorMachine, 10, pre.Gaussianizer, [pre.PCA, 5], 0, [0, C, svm.get_kernel_poly(0, 2, 0), None] if prior is None else [0, C, svm.get_kernel_poly(0, 2, 0), [1 - prior, prior]], True)
...
for prior in [0.5, None]: #[0.2, 0.5, 0.8]:
    ...
    for C in C_range:
        ...
        LTE_cross, _, scores = utils.cross_validation_base(D_BASE, L, svm.SupportVectorMachine, 10, pre.Gaussianizer, None, 0, [0, C, svm.get_kernel_poly(0, 2, 0), None] if prior is None else [0, C, svm.get_kernel_poly(0, 2, 0), [1 - prior, prior]], True)
...
for prior in [0.5, None]: #[0.2, 0.5, 0.8]:
    ...
    for C in C_range:
        ...
        LTE_cross, _, scores = utils.cross_validation_base(D_BASE, L, svm.SupportVectorMachine, 10, None, [pre.PCA, 5], 0, [0, C, svm.get_kernel_poly(0, 2, 0), None] if prior is None else [0, C, svm.get_kernel_poly(0, 2, 0), [1 - prior, prior]], True)
