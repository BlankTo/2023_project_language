...
print('Euclidean')
utils.cross_validation(D_BASE, L, 100, EuclideanClassifier, [[]], progress= True, prepro= [
    [(pre.NoTransform, [])],
    [(pre.Standardizer, [])],
...
print('Mahalanobis')
utils.cross_validation(D_BASE, L, 100, MahalanobisClassifier, [[]], progress= True, prepro= [
    [(pre.NoTransform, [])],
    [(pre.Standardizer, [])],
    [(pre.Standardizer, []), (pre.PCA, [5])],
    [(pre.Standardizer, []), (pre.PCA, [4])],
...
print('k-means 1')
utils.cross_validation(D_BASE, L, 100, KmeansClassifier, model_params, progress= True, prepro= [
    [(pre.NoTransform, [])],
    [(pre.Standardizer, [])],
    [(pre.Standardizer, []), (pre.PCA, [5])],
    [(pre.Standardizer, []), (pre.PCA, [4])],
...
print('k-means 2')
utils.cross_validation(D_BASE, L, 100, KmeansClassifier_2, model_params, progress= True, prepro= [
    [(pre.NoTransform, [])],
    [(pre.Standardizer, [])],
    [(pre.Standardizer, []), (pre.PCA, [5])],
    [(pre.Standardizer, []), (pre.PCA, [4])],
